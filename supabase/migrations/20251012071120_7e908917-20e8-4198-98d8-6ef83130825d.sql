-- Alterar a coluna user_id da tabela audit_logs para permitir NULL em operações do sistema
ALTER TABLE public.audit_logs ALTER COLUMN user_id DROP NOT NULL;

-- Atualizar a função log_modifications para lidar com operações do sistema
